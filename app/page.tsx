...
export default function ModernShield() {
  ...
  const encrypt = () => {
    ...
    try {
      ...
      alert("Syntax Error! Please check your JavaScript code.");
    }
  };
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          <div className="bg-slate-800/40 backdrop-blur-xl border border-white/10 rounded-3xl p-6 shadow-2xl">
            ...
            <textarea
              className="w-full h-80 bg-black/20 border border-white/5 rounded-2xl p-4 font-mono text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all placeholder:text-slate-600 text-white"
          ...
          <div className="bg-slate-900/60 backdrop-blur-xl border border-white/5 rounded-3xl p-6 shadow-2xl relative overflow-hidden">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex gap-2">
                <button onClick={copyToClipboard} className="p-2 bg-white/5 hover:bg-white/10 rounded-xl transition-all">
                  <Copy className={`w-5 h-5 ${isCopying ? 'text-emerald-400' : 'text-slate-400'}`} />
                </button>
                <button onClick={downloadFile} disabled={!output} className="p-2 bg-white/5 hover:bg-white/10 rounded-xl transition-all disabled:opacity-30">
